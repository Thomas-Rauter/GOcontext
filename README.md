...
`GOcontext` constructs **context-specific GO subgraphs** to reduce the
number of tested GO terms prior to enrichment testing, with the goal of
reducing multiple testing burden while preserving GO structure and
reproducibility.
...
See the full documentation at the [GOcontext
website](https://thomas-rauter.github.io/GOcontext/).
