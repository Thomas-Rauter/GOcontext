...
GO terms tested in enrichment analysis. By reducing the number of tested terms
while preserving the GO graph structure, the package aims to decrease multiple
testing burden while maintaining a transparent and reproducible GO universe.
